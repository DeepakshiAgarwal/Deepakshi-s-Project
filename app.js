...
function toggleAdminLogin() {
  if (isAdminLoggedIn) {
    ...
    document.getElementById("adminBtnLabel").textContent = "Admin"; document.getElementById("adminFloatBtn").classList.remove("active");
  ...
  if (pw === ADMIN_PASSWORD) {
    ...
    document.getElementById("adminBtnLabel").textContent = "✓ On"; document.getElementById("adminFloatBtn").classList.add("active");
